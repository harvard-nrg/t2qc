...
import t2qc.cli as cli
import t2qc.config as config
...
def main():
    ...
    parser_process.add_argument('--ses',
        help='BIDS session')
    parser_process.add_argument('--mod', default='T2w',
        help='BIDS modality')
    ...
    parser_process.add_argument('--dry-run', action='store_true',
        help='Do not execute any jobs')
    parser_process.add_argument('--sub-tasks', nargs='+', default=['mriqc', 'vnav', 'snapshots'],
    ...
    parser_tandem.add_argument('--dry-run', action='store_true',
        help='Do not execute any jobs')
    parser_tandem.add_argument('--sub-tasks', nargs='+', default=['mriqc', 'vnav', 'snapshots'],
        help='Run only certain sub tasks')
    ...
    logger.info('Welcome to T2QC version %s', t2qc.version())
